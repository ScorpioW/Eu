...
<div id="page" class="container">
    <section>
		...
		<?php
			...
			$isEmpQ = mysqli_query($link, $isEmpSTR);
		  ...
		  <?php } elseif (isset($_POST['s']) || isset($_POST['n']) && mysqli_num_rows($empregadosQ) > 0)
				{
					$i = 0;
					$empregados = array();
