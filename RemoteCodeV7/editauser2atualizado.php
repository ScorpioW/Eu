...
<!-- Page -->
	<div id="page" class="container">
		<section>
			...
			<input type="radio" name="priv" <?php echo ($registos['direitos'] =='Admin')? 'checked':'' ?> value="Admin"> Administrador &nbsp; &nbsp; 
			<input type="radio" name="priv" <?php echo ($registos['direitos'] =='User')? 'checked':'' ?> value="User"> Utilizador
