	...
	<!-- Extra -->
		<div id="extra">
			<div class="container">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
						<section class="sec"> <a href="pesqempresa.php" class="image featured"><img src="images/continternos.jpg"  alt=""></a>
							<div class="box">
								<p><strong>Empresas</strong> </p>
								<a href="pesqinternos.php" class="button">Pesquisar</a> </div>
						</section>
					</div>
