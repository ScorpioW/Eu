<?php  
	...
	$faz_lista=mysql_query($lista,$link);
	...
	if ($num_registos==0)
	{
		...
		echo "Numero Total de registos encontrados: ".$num_registos;
	}
				...
				<!-- Page -->
					<div id="page" class="container">
						<section>
								...
								<br>
									<table border="1">
									<tr><td><b> ID <td><b>Login<td><b>Password<td><b>id_contacto<td><b>direitos
