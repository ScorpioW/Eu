...
if (isset($_POST['submit']))
	{
		...
		$existe="SELECT nome, morada, codP, area, Localidade, telefone, email FROM Contacto, Telefone, Email Where nome LIKE '%$empresa%'  AND Contacto.id = Telefone.id_contacto AND Contacto.id = Email.id_contacto AND Contacto.isEmpresa = 1";
