	...
	if (isset($_POST['submit']))
		{
			...
			$id="SELECT id FROM Contacto Where Localidade LIKE '%".$localidade."%'";
			$buscaid=mysqli_query($link, $id);


			$existe="SELECT * FROM Contacto Where Localidade LIKE '%".$localidade."%' UNION SELECT telefone from Telefone where id_contacto='%".$id."%'";
